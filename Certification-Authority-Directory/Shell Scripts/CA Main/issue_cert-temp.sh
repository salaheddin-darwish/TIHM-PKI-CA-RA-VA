...
do
printf 'y\ny\n' | openssl ca -in $file  -out /home/ca-admin/ca/newcerts-ra/$(basename -s .csr $file).crt -extensions v3_OCSP -config /home/ca-admin/ca/openssl.cnf -policy policy_anything -passin pass:ca-crypto
if [ "$?" != "0" ]; then
