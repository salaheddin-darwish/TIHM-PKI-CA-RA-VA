...
<t:template>
   <jsp:attribute name="title">Registration Authority (main)</jsp:attribute>
    ...
    <p align="justify"><b>This website is developed as a front end for the Public Key Infrastructure (PKI) in the <a href= "http://www.sabp.nhs.uk/tihm">TIHM (Technology Integrated Health Management)</a> project. 
    	...
    	However, in order for users to take advantage of the website services, they need to create a new login account using the register(a sign up page).
    	Bear in mind, it is necessary to initially <a href="/tihm-pki-ra/files/TIHM-CA.crt">download</a> the root certificate and add it to the authority 
    	certificate store of your browser to be able to open the register(sign up) page.  </b><p>
    <hr style =" border-width: 3px">
    <br>
    <br>
    <br>   
